...
const Approvals = () => {
  return (
    <>
      <section className="overflow_hidden">
        <div className="pt_top max_width mx-auto">
          ...
          <div className="position-relative ">
            ...
            <div className="container  py_spacing1 mt-md-5 mt-3 mx_width">
            ...
            <img className="blue_ellipse w-100 d-md-block d-none" src={blue_ellips} alt="#" />
