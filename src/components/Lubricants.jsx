        ...
        <div className=" max_width mx-auto ">
          <div className="d-flex justify-content-between">
            <div className="text-white position-relative">
              <img className="gold_ellipse d-lg-block d-none" src={gold_ellips} alt="img" />
            </div>
            <div className=" ">
              <h1 className="text-white fw_ExtraBold ff_poppins text-uppercase fs_lg px-3">
                ...
                <span className="ff_poppins d-lg-block">
                  {" "}
                  & Grease Manufacturing
                </span>
              </h1>
              <div className="lubricants_img py_spacing mt-md-5 mt-2">
                <p className="max_w mx-auto fs_md ff_dmSans fw-normal para_clr px-3">
                ...
                <div className="max_w mx-auto pt-4 px-3">
